...
public class Hotel {
    ...
    public Hotel(String name, String city, String state, String address, String mail, String phone,
                 String star, boolean carPark, boolean wifi, boolean pool, boolean fitness, boolean concierge,
                 boolean spa, boolean roomService) {
        this.name = name;
        this.city = city;
        this.state = state;
